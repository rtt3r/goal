...
public class CommandResult_HasInternalError
{
    [Fact]
    ...
    [Fact]
    public void Should_Return_True_If_Any_Internal_Error_Notification_Is_Present()
    {
        // Arrange
    ...
    [Fact]
    public void Should_Return_False_If_No_Internal_Error_Notification_Is_Present()
    {
        // Arrange
        var notifications = new List<Notification>
        {
        ...
        // Assert
        hasInternalError.Should().BeFalse();
    }

    [Fact]
    public void WhenNotificationsContainInternalError_ReturnsTrue()
    {
        // Arrange
        var notifications = new List<Notification>
        {
            Notification.InternalError("01", "There was a internal error")
        };
        ICommandResult commandResult = CommandResult.Failure(notifications);

        // Act
        bool result = commandResult.HasInternalError;
