...
public class CommandResult_HasDomainViolation
{
    [Fact]
    ...
    [Fact]
    public void Should_Return_True_If_Any_Domain_Violation_Notification_Is_Present()
    {
        // Arrange
        ...
        // Act
        bool hasDomainViolation = commandResult.HasDomainViolation;

        // Assert
        hasDomainViolation.Should().BeTrue();
    }
    ...
    [Fact]
    public void Should_Return_False_If_No_Domain_Violation_Notification_Is_Present()
    {
        // Arrange
        var notifications = new List<Notification>
        {
        ...
        // Assert
        hasDomainViolation.Should().BeFalse();
    }

    [Fact]
    public void WhenNotificationsContainDomainViolation_ReturnsTrue()
    {
        // Arrange
        var notifications = new List<Notification>
        {
            Notification.DomainViolation("01", "There was a domain violation")
        };
        ICommandResult commandResult = CommandResult.Failure(notifications);

        // Act
        bool result = commandResult.HasDomainViolation;
