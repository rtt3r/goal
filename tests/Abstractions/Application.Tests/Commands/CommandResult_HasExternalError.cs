...
public class CommandResult_HasExternalError
{
    [Fact]
    ...
    [Fact]
    public void Should_Return_True_If_Any_External_Error_Notification_Is_Present()
    {
        // Arrange
    ...
    public void HasInformation_Should_Return_True_If_Any_Information_Notification_Is_Present()
    {
        ...
        var notifications = new List<Notification>
        {
            ...
            Notification.DomainViolation("03", "External Error notification.")
        };
        ICommandResult commandResult = CommandResult.Failure(notifications);
    ...
    [Fact]
    public void Should_Return_False_If_No_External_Error_Notification_Is_Present()
    {
        // Arrange
        var notifications = new List<Notification>
        {
        ...
        // Assert
        hasExternalError.Should().BeFalse();
    }

    [Fact]
    public void WhenNotificationsContainExternalError_ReturnsTrue()
    {
        // Arrange
        var notifications = new List<Notification>
        {
            Notification.ExternalError("01", "There was a external error")
        };
        ICommandResult commandResult = CommandResult.Failure(notifications);

        // Act
        bool result = commandResult.HasExternalError;
